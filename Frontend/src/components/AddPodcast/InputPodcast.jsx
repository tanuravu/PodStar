    ...
    const handleSubmitPodcast = async () => {
        ...
        try {
            const res = await axios.post(
                "http://localhost:8080/api/v1/add-podcast", data, { withCredentials: true },
                {
                    headers: {
            ...
            <div className="mt-5 flex flex-col lg:flex-row items-center justify-between justify-between gap-4">
                ...
                <div className="w-full lg:w-4/6">
                    ...
                    <div className="mt-8 lg:mt-6 flex">
                        <button className="bg-zinc-800 w-full text-white rounded px-8 py-2 font-semibold hover:bg-zinc-700 transition-all duration-300" onClick={handleSubmitPodcast}>Create Podcast</button>
                    </div>
                </div>
            </div>
        </div>
