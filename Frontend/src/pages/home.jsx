...
const Home = () => {
  return (
    <div className=" px-12 h-screen lg:h-[89vh] flex flex-col items-center justify-center relative">
      {/* Background Video */}
      <video
        autoPlay
        loop
      ...
      <div className="mt-12 w-full flex flex-col lg:flex-row items-end justify-between relative z-10">
        <div className="flex flex-col items-center lg:items-start justify-center">
          ...
          <Link to="/login">
          <button className="px-6 py-4 bg-zinc-800 text-white hover:font-bold rounded-full mt-6 lg:mt-8">
            Login to listen
          </button>
          </Link>
        </div>
